<section class="container py-5">
    ...
    <div style="text-align: justify;">
        <!-- Introducción y declaracion general de aceptación de terminos -->
        <p class="mb-4">
            <strong>Última actualización:</strong> 23/04/2025<br>
            Rebobinar, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio Rebobinar.com y de cualquier otro sitio web, tienda o aplicación operada por el titular. 
        ...
        <!-- Sección 1: Aceptacion de la condicion de usuario -->
        <div class="mb-4">
            <h2 class="h4">Sección 1 - Usuario</h2>
        ...
        <!-- Seccion 2: Adhesion conjunta a la politica de privacidad -->
        <div class="mb-4">
            <h2 class="h4">Sección 2 - Adhesión junto con la política de privacidad</h2>
            <p>
            El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de Rebobinar.</p>
        </div>

        <!-- Seccion 3: Condiciones de acceso y registro -->
        <div class="mb-4">
            <h2 class="h4">Sección 3 - Condiciones de acceso</h2>
            <p>En general, el acceso al sitio web de Rebobinar es gratuito y no requiere registro previo.Sin embargo, para hacer uso de algunas funcionalidades, el usuario puede necesitar registrarse, creando una cuenta de usuario con un nombre de usuario y una contraseña de acceso.
            ...
            Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas. Rebobinar no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.
            La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de Rebobinar en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.</p>
        </div>

        <!-- Seccion 4: Uso de cookies e implicaciones -->
        <div class="mb-4">
            <h2 class="h4">Sección 4 - Cookies</h2>
        ...
        <!-- Seccion 5: Propiedad intelectual del contenido del sitio -->
        <div class="mb-4">
            <h2 class="h4">Sección 5 - Propiedad intelectual</h2>
            <p>Todos los elementos de Rebobinar son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de Rebobinar o de cualquier tercero.</p>
        </div>

        <!-- Seccion 6: Enlaces a sitios de terceros y responsabilidad -->
        <div class="mb-4">
            <h2 class="h4">Sección 6 - Enlaces a sitios web de terceros</h2>
            <p>Este sitio web puede contener, de vez en cuando, enlaces de hipertexto que le redirigirán a sitios web de nuestros socios, anunciantes, proveedores, etc. Si hace clic en uno de estos enlaces a cualquiera de estos sitios, recuerde que cada sitio tiene sus propias prácticas de privacidad y que nosotros no somos responsables de estas políticas. Por favor, consulte esas políticas antes de enviar cualquier dato personal a esos sitios.
        ...
        <!-- Seccion 7: Duracion del funcionamiento y modificaciones -->
        <div class="mb-4">
            <h2 class="h4">Sección 7 - Plazos y modificaciones</h2>
            <p>El funcionamiento de este sitio web es por tiempo indefinido.
                La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por Rebobinar, en cualquier momento y sin previo aviso.
        </div>

        <!-- Seccion 8: Tratamiento de datos personales -->
        <div class="mb-4">
            <h2 class="h4">Sección 8 - Datos personales</h2>
            <p>Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por Rebobinar y/o los Socios. Las normas relativas al tratamiento de los datos personales de Rebobinar están estipuladas en la Política de Privacidad.
        </div>

        <!-- Seccion 9: Informacion de contacto -->
        <div class="mb-4">
            <h2 class="h4">Sección 9 - Contacto</h2>
            <p>Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico contactoRebobinar@rebobinar.com.</div>
    </div>
</section>
